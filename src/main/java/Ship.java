...
public class Ship extends JPanel implements MouseMotionListener {
    ...
    public Ship(int liczbaMeteorytow) throws InterruptedException {
        ...
        try {
            image = ImageIO.read(new File("files/statek2.png"));
            image2 = ImageIO.read(new File("files/statek3.png"));
            imageMeteoryt = ImageIO.read(new File("files/meteoryt.png"));
            zycieZdjecie = ImageIO.read(new File("files/zycie.png"));
            coinZdjecie = ImageIO.read(new File("files/coin4.png"));
            strzalZdjecie = ImageIO.read(new File("files/strzal.png"));
